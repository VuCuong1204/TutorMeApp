...
class LessonAdapter : TutorMeAdapter() {
    override fun getLayoutResource(viewType: Int): Int = R.layout.lesson_home_item

    override fun onCreateViewHolder(viewType: Int, binding: ViewDataBinding): BaseVH<*>? {
        return LessonVH(binding as LessonHomeItemBinding)
    }

    inner class LessonVH(private val binding: LessonHomeItemBinding) : BaseVH<LessonInfo>(binding) {
